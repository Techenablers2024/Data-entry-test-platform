...
func main() {
	...
	authProtected.PATCH("/me/bank", authHandler.UpdateBank)
	...
	admin.PATCH("/users/:id/extend-validity", adminHandler.ExtendValidity)
	admin.POST("/users/:id/reset-password", adminHandler.ResetPassword)
	admin.GET("/users/:id/sessions", adminHandler.UserSessions)
	admin.GET("/users/:id/test-periods", adminHandler.TestPeriods)
